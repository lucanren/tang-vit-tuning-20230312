...
for a,b,c,d,e in [(10,4,12,2,100)]:

    savepathname=f'ble{batch_size}_{learn_rate}_{e}'
    GF.mkdir('./bs-lr-ep-results/',savepathname)
    log = open(f'./bs-lr-ep-results/ble{batch_size}_{learn_rate}_{e}/log.txt', "w")
    ...
    for epoch in range(e):
        ...
        #torch.save(net.state_dict(),  f'./bs-lr-ep-results/ble{batch_size}_{learn_rate}_{e}/model_test.pth')
